...
#ifndef QMODBUSRTUSERVER_P_H
#define QMODBUSRTUSERVER_P_H
...
#include <private/qmodbusrtuserialclient_p.h>
...
class QModbusRtuServerPrivate : public QModbusClientPrivate
{
    Q_DECLARE_PUBLIC(QModbusRtuServer)
protected:
    enum State
    {
        Idle,
