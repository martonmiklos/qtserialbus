...
#include "qmodbusrtutcpserver.h"
#include "qmodbusrtutcpserver_p.h"
...
/*!
    \class QModbusRtuTcpServer
    \inmodule QtSerialBus
    \since 5.8

    \brief The QModbusRtuTcpServer class represents a Modbus client
...
*/
QModbusRtuTcpServer::QModbusRtuTcpServer(QObject *parent)
    : QModbusRtuServer(new QModbusRtuTcpServerPrivate, parent)
{
    Q_D(QModbusRtuTcpServer);
    d->setupDevice();
}
...
/*!
    \internal
*/
QModbusRtuTcpServer::~QModbusRtuTcpServer()
{
    close();
}
...
/*!
    \internal
*/
QModbusRtuTcpServer::QModbusRtuTcpServer(QModbusRtuTcpServerPrivate &dd, QObject *parent)
    : QModbusRtuServer(dd, parent)
{
    Q_D(QModbusRtuTcpServer);
    d->setupDevice();
}
...
/*!
     \reimp
*/
void QModbusRtuTcpServer::close()
{
    ...
    while (!d->m_queue.isEmpty()) {
        ...
        QModbusRtuTcpServerPrivate::QueueElement elem = d->m_queue.dequeue();
