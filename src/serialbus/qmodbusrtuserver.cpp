...
#include "qmodbusrtuserver.h"
#include "qmodbusrtuserver_p.h"
...
/*!
    \class QModbusRtuServer
    \inmodule QtSerialBus
    \since 5.8

    \brief The QModbusRtuServer class represents a Modbus client
...
*/
QModbusRtuServer::QModbusRtuServer(QModbusClientPrivate *p, QObject *parent)
    : QModbusClient(*p, parent)
{
    Q_D(QModbusRtuServer);
    d->setupDevice();
}
...
/*!
    \internal
*/
QModbusRtuServer::~QModbusRtuServer()
{
...
*/
int QModbusRtuServer::interFrameDelay() const
{
    Q_D(const QModbusRtuServer);
...
*/
void QModbusRtuServer::setInterFrameDelay(int microseconds)
{
    Q_D(QModbusRtuServer);
...
/*!
    ...
    \c 100 milliseconds.
*/
int QModbusRtuServer::turnaroundDelay() const
{
    Q_D(const QModbusRtuServer);
...
/*!
    ...
    milliseconds.
*/
void QModbusRtuServer::setTurnaroundDelay(int turnaroundDelay)
{
    Q_D(QModbusRtuServer);
...
/*!
    \internal
*/
QModbusRtuServer::QModbusRtuServer(QModbusRtuServerPrivate &dd, QObject *parent)
