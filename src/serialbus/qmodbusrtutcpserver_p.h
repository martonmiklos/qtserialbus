...
**
****************************************************************************/
#ifndef QMODBUSRTUTCPSERVER_P_H
#define QMODBUSRTUTCPSERVER_P_H
...
#include <QtSerialBus/qmodbusrtutcpserver.h>
#include <QTcpSocket>
...
class QModbusRtuTcpServerPrivate : public QModbusRtuServerPrivate
{
    Q_DECLARE_PUBLIC(QModbusRtuTcpServer)
public:
    ...
    {
        Q_Q(QModbusRtuTcpServer);
        m_socket = new QTcpSocket(q);
        m_ioDevice = m_socket;
        QModbusRtuServerPrivate::setupDevice();
    ...
    void setupEnvironment() override
    {
        ...
        m_state = QModbusRtuServerPrivate::Idle;
    }
